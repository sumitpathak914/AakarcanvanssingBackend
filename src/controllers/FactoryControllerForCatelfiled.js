const User = require('../model/FactoryForCatelfiled');

const FactoryCatelfilduserController = {
    SaveFactory: async (req, res) => {
        const factoryData = req.body;

        try {
            // Create a new Factory document
            const newFactory = new User({
...
module.exports = FactoryCatelfilduserController;
